...
$('.user1').on("change", "#input1", function () {
  if (event.target.files.length > 0) {
    ...
    $("#image1Col").append("<img width='80%' height='100px' src='" + outputSrc1 + "'/>");
  }
});
$('.user2').on("change", "#input2", function () {
  if (event.target.files.length > 0) {
    ...
    $("#image2Col").append("<img width='80%' height='100px' src='" + outputSrc2 + "'/>");
  }
});
$('.user3').on("change", "#input3", function () {
  if (event.target.files.length > 0) {
    ...
    $("#image3Col").append("<img width='80%' height='100px' src='" + outputSrc3 + "'/>");
  }
});
$('.user4').on("change", "#input4", function () {
  if (event.target.files.length > 0) {
    ...
    $("#image4Col").append("<img width='80%' height='100px' src='" + outputSrc4 + "'/>");
...
function getLaps() {
  if (($("#name1").val()) == "" || ($("#name2").val()) == "" || ($("#name3").val()) == "" || ($("#name4").val()) == "" ) {
    Swal.fire("OYUNCU İSİMLERİNİ GİR");
  }
  else if (!($('input:checkbox').is(":checked"))) {
    Swal.fire("İLK BAŞLAYACAK OLANI");
  }
  else {
    ...
    selIt = $("#selectedItem").val(); 
    selectedItem = parseInt(selIt); 
